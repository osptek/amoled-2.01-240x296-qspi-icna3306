...
OSPTEK **2.01″ 240×296 AMOLED** is a **QSPI** color display module driven by **ICNA3306**, with touch **CST816D**.

Spec ID (repository name): `amoled-2.01-240x296-qspi-icna3306`

Current module version: **AM201Q240296LK**. Electrical and mechanical details follow [`docs/AM201Q240296LK.pdf`](./docs/AM201Q240296LK.pdf).
...
└── versions/
    └── AM201Q240296LK/                      # full materials for this part number
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
...
| Resource | Link |
| ---- | ---- |
| Product datasheet (AM201Q240296LK) | [`docs/AM201Q240296LK.pdf`](./docs/AM201Q240296LK.pdf) |
